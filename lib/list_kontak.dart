...
class _ListKontakPageState extends State<ListKontakPage> {
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Email: ${kontak.mobileNo}"),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(
                        top: 8,
                      ),
                      child: Text("Email: ${kontak.company}"),
                    ),
                  ],
                ),
                trailing: FittedBox(
  ...
  Future<void> _getAllKontak() async {
    ...
    //perubahan state
    setState(() {
      //menghapus semua data pada listKontak
      listKontak.clear();

      //perulangan pada variabel list
      list!.forEach((kontak) {
        //memasukkan data ke listKontak
